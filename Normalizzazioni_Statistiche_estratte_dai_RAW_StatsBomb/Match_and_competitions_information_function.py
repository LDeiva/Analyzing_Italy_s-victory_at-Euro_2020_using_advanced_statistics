...
def match_information(competition_id,season_id):
    ...
    with open(rf'C:\Users\hp\OneDrive\Football Analytics\Calcio\Dati e Progetti\Dati\open-data-master\data\competitions.json') as data_file:
    ...
    with open(rf'C:\Users\hp\OneDrive\Football Analytics\Calcio\Dati e Progetti\Dati\open-data-master\data\matches\{competition_id}\{season_id}.json',  encoding="utf8") as data_file:
        #print (mypath+'events/'+file)
